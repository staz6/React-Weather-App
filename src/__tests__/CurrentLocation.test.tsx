...
import CurrentLocation from "../Components/Compound/CurrentLocation";
...
beforeEach(() => {
  // Temporarily override navigator.geolocation for each test
  ...
  mockGeolocation.getCurrentPosition.mockImplementationOnce(
    (_: PositionCallback, error: PositionErrorCallback) =>
      error({
        code: 1,
        PERMISSION_DENIED: 1,
        message: "Geolocation is not enabled or not supported by this browser.",
